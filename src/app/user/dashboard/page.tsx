      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Thank you for joining our course management platform. As a general
            user, you have access to basic features and can explore the platform
            capabilities.
          </p>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              If you need additional permissions or want to become a student,
              developer, or manager, please contact your administrator.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
